package com.mf.springboot.springdata.envers.controller;
...
import com.mf.springboot.springdata.envers.service.BlogService;
...
public class BlogController {
	...
	public User updateUser(@PathVariable Integer userID, @RequestBody User user){
		return blogService.editUser(userID, user);
	}
